...
import { activateStudioFinalV257 } from "./scripts/activate-studio-final-v257.mjs";
  ...
  plugins: [
    {
      ...
      async buildStart() {
        ...
        console.log(`[vite] ${v256.release} keeps v255 interaction authority after v253`);
        const v257 = await activateStudioFinalV257();
        console.log(`[vite] ${v257.release} adds Theme geometry without mutating Theme core during Vite startup`);
        console.log(`[vite] ${v257.themeLayoutRelease} is the final Theme geometry authority`);
      },
      closeBundle() {
