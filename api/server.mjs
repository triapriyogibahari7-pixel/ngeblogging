...
function capabilityPayload(env) {
  ...
  return {
    ...
    localPayments,
    nara,
    imageGeneration:Boolean(nara && databasePublic),
    customDomains:Boolean(databaseAdmin && env.CLOUDFLARE_ZONE_ID && env.CLOUDFLARE_API_TOKEN && env.CUSTOM_DOMAIN_CNAME_TARGET),
