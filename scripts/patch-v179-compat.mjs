...
if (!source.includes(marker)) {
  const anchor = 'const VERSION = "ngeblogging-app-v179-production-stability-20260731";';
  if (!source.includes(anchor)) throw new Error("PATCH_V179_COMPAT_VERSION_MISSING");
