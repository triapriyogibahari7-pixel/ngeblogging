...
function patchWorker() {
  ...
  source = replaceRequired(source, '    && html.includes("ngeblogging-screenshot-stability-v177")', '    && html.includes("ngeblogging-screenshot-stability-v177")\n    && html.includes("ngeblogging-mobile-auth-interaction-v179")', "worker marker condition v179");
  source = replaceRequired(source, '    `<meta name="ngeblogging-screenshot-stability-v177" content="${SCREENSHOT_STABILITY_RELEASE}"/>`,', '    `<meta name="ngeblogging-screenshot-stability-v177" content="${SCREENSHOT_STABILITY_RELEASE}"/>`,\n    `<meta name="ngeblogging-mobile-auth-interaction-v179" content="${MOBILE_AUTH_INTERACTION_RELEASE}"/>`,', "worker marker v179");
  source = source.replaceAll('  headers.set("x-ngeblogging-screenshot-stability", SCREENSHOT_STABILITY_RELEASE);', '  headers.set("x-ngeblogging-screenshot-stability", SCREENSHOT_STABILITY_RELEASE);\n  headers.set("x-ngeblogging-mobile-auth-interaction", MOBILE_AUTH_INTERACTION_RELEASE);');
  write(file, source);
}
...
function patchNetlify() {
  ...
  source = replaceRequired(source, 'const SCREENSHOT_STABILITY_RELEASE = "2026.07.31-screenshot-stability-v177";', `const SCREENSHOT_STABILITY_RELEASE = "2026.07.31-screenshot-stability-v177";\nconst MOBILE_AUTH_INTERACTION_RELEASE = "${WORKER_RELEASE}";`, "Netlify v177 release");
  source = replaceRequired(source, '  X-Ngeblogging-Screenshot-Stability: ${SCREENSHOT_STABILITY_RELEASE}', '  X-Ngeblogging-Screenshot-Stability: ${SCREENSHOT_STABILITY_RELEASE}\n  X-Ngeblogging-Mobile-Auth-Interaction: ${MOBILE_AUTH_INTERACTION_RELEASE}', "Netlify header v179");
  source = replaceRequired(source, '/release-v177.json\n  Cache-Control: no-store, max-age=0\n`,', '/release-v177.json\n  Cache-Control: no-store, max-age=0\n/release-v179.json\n  Cache-Control: no-store, max-age=0\n`,', "Netlify release path v179");
  source = replaceRequired(source, '    screenshotStabilityRelease: SCREENSHOT_STABILITY_RELEASE,', '    screenshotStabilityRelease: SCREENSHOT_STABILITY_RELEASE,\n    mobileAuthInteractionRelease: MOBILE_AUTH_INTERACTION_RELEASE,\n    drawerBackdropOutsideOnlyV179: true,\n    naraSmallMediumNonmodalV179: true,\n    oauthAuthorizeDirectTransportV179: true,\n    profileFinalizationCompatibility: "studio-finalization-v178-20260731",', "Netlify body v179");
  source = replaceRequired(source, '    || !html.includes(\'name="ngeblogging-screenshot-stability-v177"\')', '    || !html.includes(\'name="ngeblogging-screenshot-stability-v177"\')\n    || !html.includes(\'name="ngeblogging-mobile-auth-interaction-v179"\')', "Netlify marker condition v179");
