...
// geometry; v232 owns the current screenshot UI; v233 owns fast safe data-gateway
// failover so an authenticated session is not trapped at the Studio startup surface.
