...
// geometry; v232 owns the current screenshot UI; v233 adds bounded gateway
// failover after v224 so authenticated Studio bootstrap can recover from stale routes.
