...
export const VERSION = "ngeblogging-app-v260-stability-r3-20260804";
export const CACHE = "studio-stability-cache-v260-r3";
...
export function rotateServiceWorkerV259(target = resolve("dist", "sw.js")) {
  ...
  source = source
    ...
    .replaceAll("service-worker-activated-theme-right4-v258", "service-worker-activated-stability-v260-r3")
    .replaceAll("service-worker-activated-six-mode-v259", "service-worker-activated-stability-v260-r3")
    .replaceAll("service-worker-activated-stability-v260-r2", "service-worker-activated-stability-v260-r3")
    .replaceAll("service-worker-activated-stability-v260", "service-worker-activated-stability-v260-r3");
