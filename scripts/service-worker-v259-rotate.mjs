...
export const VERSION = "ngeblogging-app-v259-six-mode-authority-20260804";
export const CACHE = "studio-six-mode-cache-v259";
...
export function rotateServiceWorkerV259(target = resolve("dist", "sw.js")) {
  ...
  insertAfterVersion(`const STUDIO_SIX_MODE_RELEASE_V259 = "${RELEASE}";`);
  ...
  source = source
    ...
    .replaceAll("service-worker-activated-theme-right4-v258", "service-worker-activated-six-mode-v259");

  if (source.includes("function versionPayload(type)") && !source.includes("studioSixModeReleaseV259:")) {
