...
if (String(process.env.NETLIFY || "").toLowerCase() === "true") {
  ...
  if (!html.includes('name="ngeblogging-auth-editor-v162"')) {
    const markers = [
  ...
  console.log(`Netlify React authority ${PRODUCTION_ENTRY_RELEASE}, Studio ${STUDIO_ROUTE_RELEASE}, konten ${CONTENT_WORKFLOW_RELEASE}, dan auth/editor ${AUTH_EDITOR_RELEASE} aktif; API diarahkan ke ${apiOrigin}`);
}
