...
const result = spawnSync(process.execPath, ["--test", "tests/mobile-interaction-v174.test.mjs"], { cwd: process.cwd(), stdio: "inherit", env: process.env });
if (result.status !== 0) process.exit(result.status || 1);
await mkdir("dist", { recursive: true });
await writeFile("dist/index.html", "<!doctype html><html><body><h1>MOBILE_INTERACTION_V174_OK</h1></body></html>", "utf8");
