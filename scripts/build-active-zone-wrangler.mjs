...
if (validCloudflareId(zoneId)) {
  ...
  console.log("Route produksi resmi dan route catch-all SaaS dikunci memakai Zone ID aktif.");
} else {
  /*
   ...
   * upload hanya memperbarui kode/aset Worker; route yang sudah aktif tetap
   * dipertahankan di Cloudflare. Jalur API cadangan dibuktikan langsung melalui
   * hostname workers.dev resmi.
   */
