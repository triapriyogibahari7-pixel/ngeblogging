...
function clearLegacyInlineLayout() {
  ...
  // StudioNext already declares a React navigation owner. Preserve that marker so
  // compatibility bridges continue to stand down instead of creating duplicate
  // menu items while v140 remains the only geometry/device authority.
