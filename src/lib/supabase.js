...
const AUTH_RELEASE = "auth-resilience-v255-20260804";
...
const DATA_TRANSPORT_RELEASE_V190 = "studio-data-gateway-v255-20260804";
...
async function fetchAuthGatewayWithDeadline(input, init) {
  ...
  return Promise.race([
    ...
    new Promise((_, reject) => {
      timer = globalThis.setTimeout(() => reject(Object.assign(new Error("Gateway autentikasi melewati batas waktu; menggunakan jalur langsung."), {
...
export const supabase = supabaseConfigured
  ? createClient(url, key, {
      ...
      global: {
        ...
        headers: {
          "x-client-info": "ngeblogging-web-v255",
        },
      },
    })
  : null;
...
if (typeof document !== "undefined") {
  ...
  document.documentElement.dataset.supabaseTransport = supabaseConfigured ? "auth-data-resilience-v255" : "not-configured";
