...
is 'Studio analytics dashboard v213. Returns real page-view totals, time series, human/bot, device, browser when collected, bot names, referrers, countries, first entry pages, and content performance. No synthetic production values.';
