...
-- Guard UI tetap ada, tetapi trigger ini mencegah bypass melalui request langsung/race condition.
...
comment on function public.enforce_owner_site_limit_v169() is
  'Menolak pembuatan situs ke-26 untuk pemilik yang sama; authority site-policy-v169-20260730.';
