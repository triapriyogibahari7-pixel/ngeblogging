...
test("service worker rotates stale UI caches to v138", () => {
  ...
  assert.match(worker, /ngeblogging-app-v138-navigation-20260729/);
  assert.match(worker, /react-sidebar-device-authority-v138-20260729/);
  assert.match(worker, /pwa-v138-navigation/);
});
