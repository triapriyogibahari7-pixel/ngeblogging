...
test("Studio loads base, production, real-device, and final critical layers in order", () => {
  ...
  assert.ok(index.indexOf("studio-mobile-navigation.js") < index.indexOf("studio-runtime-layout-guard.js"));
