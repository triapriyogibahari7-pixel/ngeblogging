...
test("index loads v41 after v40 and v39 authorities", () => {
  ...
  assert.ok(v40Js >= 0 && v41LayoutJs > v40Js && v41OperationsJs > v41LayoutJs);
});
...
test("members and domains remain gated by real backend readiness", () => {
  ...
  assert.match(domains, /SUPABASE_SERVICE_ROLE_KEY/);
