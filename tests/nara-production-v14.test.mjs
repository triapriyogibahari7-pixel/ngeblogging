...
test("Nara launcher and assistant remain visible clickable and above Studio", async () => {
  ...
  assert.match(studioCss, /\.nara-floating-button[\s\S]*pointer-events: auto !important/);
  assert.match(naraCss, /\.nara-floating-button[\s\S]*z-index: 2147483000 !important/);
  assert.match(naraCss, /\.nara-assistant-layer[\s\S]*pointer-events: auto !important/);
