...
test("v30 assets are active after archived compatibility authorities", async () => {
  ...
  assert.ok(index.indexOf("studio-shell-v30.css") > index.indexOf("studio-shell-v29.css"));
  assert.match(index, /<script type="application\/x-disabled" src="\/src\/studio-runtime-v23\.js" data-disabled-authority="v23"><\/script>/);
  assert.match(index, /<script type="application\/x-disabled" src="\/src\/studio-shell-v29\.js" data-disabled-authority="v29"><\/script>/);
  assert.match(index, /<script type="module" src="\/src\/studio-shell-v30\.js"><\/script>/);
