...
test("v41 health reports safe custom-domain readiness without service role", async () => {
  ...
  for (const marker of ["2026.07.26-custom-domains-v41", "apiToken", "zoneId", "cnameTarget", "databaseAccess", "serviceRoleRequired: false", 'databaseMode: "user-jwt-rls"', "customDomainServiceRoleRequired"]) assert.ok(worker.includes(marker), marker);
