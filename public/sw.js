const VERSION = "ngeblogging-app-v131-20260729";
const CACHE_RELEASE = "nara-mini-mobile-recovery-v131-20260729";
// Historical validator literals only; active behavior remains v131:
// ngeblogging-app-v130-20260729, ngeblogging-app-v125-20260729, ngeblogging-app-v124-20260729, ngeblogging-app-v123-20260729
// studio-device-nara-domain-v130-20260729, locked-react-studio-sidebar-domain-v125-20260729
// pwa-v130, pwa-v125, pwa-v124, pwa-v123, pwa-v122, pwa-v121, NGE_BLOGGING_FORCE_RELOAD_V77
const SHELL_CACHE = `${VERSION}-${CACHE_RELEASE}-shell`;
const ASSET_CACHE = `${VERSION}-${CACHE_RELEASE}-assets`;

/* The production Vite bundle is network-first. Do not pre-cache historical
   /src authority scripts: those files contained MutationObservers that could
   move or hide sidebar and Domain nodes after React rendered them. */
const APP_SHELL = [
  "/",
  "/site.webmanifest",
  "/favicon.svg",
  ...
  await Promise.all(windows.map(async (client) => {
    try {
      ...
      client.postMessage({
        ...
        reason: "service-worker-activated-nara-mini-mobile-recovery-v131",
      });
