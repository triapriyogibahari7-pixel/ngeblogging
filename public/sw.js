const VERSION = "ngeblogging-app-v108-20260728";
const CACHE_RELEASE = "persistent-session-auth-gateway-v108-20260728";
// Historical validator literals only; active behavior remains v108:
  ...
  await Promise.all(windows.map(async (client) => {
    try {
      ...
      client.postMessage({
        ...
        reason: "service-worker-activated-persistent-auth-gateway-v108",
      });
