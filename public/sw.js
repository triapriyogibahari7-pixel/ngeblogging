...
async function refreshStaleWindow(client, url) {
  ...
  try {
    ...
    // Pesan controller tetap menjadi jalur cadangan bila navigasi WindowClient ditolak browser.
  }
}
  ...
  await Promise.all(windows.map(async (client) => {
    try {
      ...
      client.postMessage({
        ...
        reason: "service-worker-activated-studio-recovery-v151",
      });
