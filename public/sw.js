const VERSION = "ngeblogging-app-v104-20260728";
const CACHE_RELEASE = "studio-native-comments-desktop-draft-preview-v104-20260728";
// Historical validator literals only; active behavior remains v104:
  ...
  await Promise.all(windows.map(async (client) => {
    try {
      ...
      client.postMessage({
        ...
        reason: "service-worker-activated-studio-final-v104",
      });
