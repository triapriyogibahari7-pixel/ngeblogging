const VERSION = "ngeblogging-app-v106-20260728";
const CACHE_RELEASE = "dashboard-session-theme-editor-v106-20260728";
// Historical validator literals only; active behavior remains v106:
  ...
  await Promise.all(windows.map(async (client) => {
    try {
      ...
      client.postMessage({
        ...
        reason: "service-worker-activated-dashboard-editor-v106",
      });
