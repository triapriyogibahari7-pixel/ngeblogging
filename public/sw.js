const VERSION = "ngeblogging-app-v147-studio-interface-20260729";
const LEGACY_VERSION = "ngeblogging-app-v145-studio-mobile-cache-20260729";
const CACHE_RELEASE = "single-react-interface-v147";
...
const FORCE_REFRESH_VALUE = "studio-interface-v147";
...
async function refreshStaleWindow(client, url) {
  ...
  url.searchParams.set("recovery_reason", "service-worker-stale-shell-v147");
  try {
  ...
  await Promise.all(windows.map(async (client) => {
    try {
      ...
      client.postMessage({
        ...
        reason: "service-worker-activated-studio-interface-v147",
      });
