const VERSION = "ngeblogging-app-v111-20260728";
const CACHE_RELEASE = "studio-flow-integrity-v111-20260728";
// Historical validator literals only; active behavior remains v111:
  ...
  await Promise.all(windows.map(async (client) => {
    try {
      ...
      client.postMessage({
        ...
        reason: "service-worker-activated-studio-flow-integrity-v111",
      });
