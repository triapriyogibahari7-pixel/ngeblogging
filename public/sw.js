const VERSION = "ngeblogging-app-v105-20260728";
const CACHE_RELEASE = "studio-theme-editor-actions-wrap-v105-20260728";
// Historical validator literals only; active behavior remains v105:
...
const APP_SHELL = ["/", "/site.webmanifest", "/favicon.svg", "/comments-v93.css", "/comments-v93.js", "/src/studio-ui-stability-v95.css", "/src/studio-ui-stability-v95.js", "/src/studio-surface-authority-v100.css", "/src/studio-surface-authority-v100.js", "/src/studio-mobile-precision-v99.css", "/src/studio-mobile-precision-v99.js", "/src/studio-final-v103.css", "/src/studio-final-v104.css", "/src/studio-final-v104.js", "/src/studio-final-v105.css", "/src/studio-final-v105.js", "/src/studio-code-wrap-v105.css"];
const RECOVERY_QUERY = "ngeblogging_recovery";
const RECOVERY_VALUE = "pwa-v105";
  ...
  await Promise.all(windows.map(async (client) => {
    try {
      ...
      client.postMessage({
        ...
        reason: "service-worker-activated-studio-final-v105",
      });
