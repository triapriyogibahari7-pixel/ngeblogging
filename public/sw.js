const VERSION = "ngeblogging-app-v110-20260728";
const CACHE_RELEASE = "same-origin-data-gateway-v110-20260728";
// Historical validator literals only; active behavior remains v110:
  ...
  await Promise.all(windows.map(async (client) => {
    try {
      ...
      client.postMessage({
        ...
        reason: "service-worker-activated-same-origin-data-gateway-v110",
      });
