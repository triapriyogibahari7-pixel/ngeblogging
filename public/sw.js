...
const CACHE_RELEASE = "studio-mobile-theme-layout-v101-20260728";
...
// studio-ui-stability-v95-20260728, pwa-v95, service-worker-activated-studio-ui-stability-v95
  ...
  await Promise.all(windows.map(async (client) => {
    try {
      ...
      client.postMessage({
        ...
        reason: "service-worker-activated-studio-mobile-theme-layout-v101",
      });
