const VERSION = "ngeblogging-app-v114-20260729";
const CACHE_RELEASE = "login-data-gateway-v114-20260729";
// Historical validator literals only; active behavior remains v114:
  ...
  await Promise.all(windows.map(async (client) => {
    try {
      ...
      client.postMessage({
        ...
        reason: "service-worker-activated-login-data-gateway-v114",
      });
