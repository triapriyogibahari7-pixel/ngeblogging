const VERSION = "ngeblogging-app-v113-20260729";
const CACHE_RELEASE = "sidebar-domain-order-v113-20260729";
// Historical validator literals only; active behavior remains v113:
  ...
  await Promise.all(windows.map(async (client) => {
    try {
      ...
      client.postMessage({
        ...
        reason: "service-worker-activated-sidebar-domain-order-v113",
      });
