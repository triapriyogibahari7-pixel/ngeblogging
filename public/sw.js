const VERSION = "ngeblogging-app-v112-20260728";
const CACHE_RELEASE = "domain-single-authority-v112-20260728";
// Historical validator literals only; active behavior remains v112:
  ...
  await Promise.all(windows.map(async (client) => {
    try {
      ...
      client.postMessage({
        ...
        reason: "service-worker-activated-domain-single-authority-v112",
      });
