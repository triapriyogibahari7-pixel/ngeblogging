...
const CACHE_RELEASE = "studio-surface-authority-v100-20260728";
// Compatibility markers retained for production validators:
// ngeblogging-app-v100-20260728, ngeblogging-app-v98-20260728, ngeblogging-app-v97-20260728, ngeblogging-app-v95-20260728, ngeblogging-app-v94-20260728, ngeblogging-app-v93-20260728.
const SHELL_CACHE = `${VERSION}-${CACHE_RELEASE}-shell`;
const ASSET_CACHE = `${VERSION}-${CACHE_RELEASE}-assets`;
const APP_SHELL = ["/", "/site.webmanifest", "/favicon.svg", "/comments-v93.css", "/comments-v93.js", "/src/studio-ui-stability-v95.css", "/src/studio-ui-stability-v95.js", "/src/studio-surface-authority-v100.css", "/src/studio-surface-authority-v100.js"];
const RECOVERY_QUERY = "ngeblogging_recovery";
const RECOVERY_VALUE = "pwa-v100";
  ...
  await Promise.all(windows.map(async (client) => {
    try {
      ...
      client.postMessage({
        ...
        reason: "service-worker-activated-studio-surface-authority-v100",
      });
