...
async function recoverOpenWindows() {
  ...
  await Promise.all(windows.map(async (client) => {
    try {
      ...
      // Pesan v77 dipertahankan agar runtime browser lama tetap memahami reload terjaga.
      client.postMessage({
        type: "NGE_BLOGGING_FORCE_RELOAD_V77",
        version: VERSION,
        reason: "service-worker-activated-domain-manager-v79",
      });
