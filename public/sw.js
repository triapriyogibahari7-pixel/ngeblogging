const VERSION = "ngeblogging-app-v122-20260729";
const CACHE_RELEASE = "sidebar-axis-domain-separator-v122-20260729";
// Historical validator literals only; active behavior remains v122:
...
const APP_SHELL = ["/", "/site.webmanifest", "/favicon.svg", "/comments-v93.css", "/comments-v93.js", "/src/studio-ui-stability-v95.css", "/src/studio-ui-stability-v95.js", "/src/studio-surface-authority-v100.css", "/src/studio-surface-authority-v100.js", "/src/studio-mobile-precision-v99.css", "/src/studio-mobile-precision-v99.js", "/src/studio-final-v103.css", "/src/auth-callback-authority-v107.js", "/src/auth-studio-bootstrap-v106.js", "/src/studio-final-v106.css", "/src/studio-final-v106.js", "/src/studio-flow-integrity-v111.css", "/src/studio-flow-integrity-v111.js", "/src/studio-domain-single-authority-v112.css", "/src/studio-domain-single-authority-v112.js", "/src/sidebar-account-collapsed-icons-v119.css"];
const RECOVERY_QUERY = "ngeblogging_recovery";
const RECOVERY_VALUE = "pwa-v122";
  ...
  await Promise.all(windows.map(async (client) => {
    try {
      ...
      client.postMessage({
        ...
        reason: "service-worker-activated-sidebar-axis-domain-separator-v122",
      });
