const VERSION = "ngeblogging-app-v121-20260729";
const CACHE_RELEASE = "sidebar-collapsed-footer-icons-v121-20260729";
// Historical validator literals only; active behavior remains v121:
  ...
  await Promise.all(windows.map(async (client) => {
    try {
      ...
      client.postMessage({
        ...
        reason: "service-worker-activated-sidebar-collapsed-footer-icons-v121",
      });
