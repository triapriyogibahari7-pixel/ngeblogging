const VERSION = "ngeblogging-app-v102-20260728";
const CACHE_RELEASE = "studio-responsive-precision-v102-20260728";
// Historical validator literals only; active behavior remains v102:
...
const APP_SHELL = ["/", "/site.webmanifest", "/favicon.svg", "/comments-v93.css", "/comments-v93.js", "/src/studio-ui-stability-v95.css", "/src/studio-ui-stability-v95.js", "/src/studio-surface-authority-v100.css", "/src/studio-surface-authority-v100.js", "/src/studio-mobile-precision-v99.css", "/src/studio-mobile-precision-v99.js"];
const RECOVERY_QUERY = "ngeblogging_recovery";
const RECOVERY_VALUE = "pwa-v102";
...
async function recoverOpenWindows() {
  ...
  await Promise.all(windows.map(async (client) => {
    try {
      ...
      client.postMessage({
        type: "NGE_BLOGGING_FORCE_RELOAD_V102",
        version: VERSION,
        release: CACHE_RELEASE,
        reason: "service-worker-activated-studio-responsive-precision-v102",
      });
