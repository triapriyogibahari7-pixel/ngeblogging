const VERSION = "ngeblogging-app-v109-20260728";
const CACHE_RELEASE = "studio-session-replay-v109-20260728";
// Historical validator literals only; active behavior remains v109:
  ...
  await Promise.all(windows.map(async (client) => {
    try {
      ...
      client.postMessage({
        ...
        reason: "service-worker-activated-studio-session-replay-v109",
      });
