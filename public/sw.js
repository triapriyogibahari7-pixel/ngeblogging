const VERSION = "ngeblogging-app-v107-20260728";
const CACHE_RELEASE = "explicit-pkce-callback-dashboard-v107-20260728";
// Historical validator literals only; active behavior remains v107:
  ...
  await Promise.all(windows.map(async (client) => {
    try {
      ...
      client.postMessage({
        ...
        reason: "service-worker-activated-explicit-auth-callback-v107",
      });
