const VERSION = "ngeblogging-app-v130-20260729";
const CACHE_RELEASE = "studio-device-nara-domain-v130-20260729";
// Historical validator literals only; active behavior remains v130:
// ngeblogging-app-v125-20260729, ngeblogging-app-v124-20260729, ngeblogging-app-v123-20260729
// locked-react-studio-sidebar-domain-v125-20260729, domain-comments-sidebar-lock-v123-20260729
// pwa-v125, pwa-v124, pwa-v123, pwa-v122, pwa-v121, NGE_BLOGGING_FORCE_RELOAD_V77
  ...
  await Promise.all(windows.map(async (client) => {
    try {
      ...
      client.postMessage({
        ...
        reason: "service-worker-activated-studio-device-nara-v130",
      });
